...
reuniendo dicha información.Los archivos detalles con nacimientos, contendrán la siguiente información: nro partida
...
TYPE
	...
	{registros detalles}
	registro_fallecido = record
		
	end;
	registro_nacimiento = record
